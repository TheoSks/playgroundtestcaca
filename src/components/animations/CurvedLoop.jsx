...
const CurvedLoop = ({ marqueeText = '', speed = 2, className, curveAmount = 400, direction = 'left', interactive = true }) => {
  ...
  const onPointerMove = e => {
    ...
    lastXRef.current = e.clientX; velRef.current = dx;
    const currentOffset = parseFloat(textPathRef.current.getAttribute('startOffset') || '0');
  ...
  return (
    <div className="curved-loop-jacket" style={{ visibility: ready ? 'visible' : 'hidden', cursor: cursorStyle, minHeight: 'auto' }}
